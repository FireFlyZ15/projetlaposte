        ...
        <div class="col-md-2 bg" id="resizableLeft">
            ...
            <form action="">
                <div class="form-inline form-group">
                    <label for="wording"><?=COLUMN_LABEL?></label><br/>
                    ...
                    <label for="group"><?=LINE_LABEL?></label><br/>
            ...
            <?=generate_save_graph_form($name,$description, $listGroup, $group,$config,$image_name,$public,$live,"table2D",$id)?>
        </div>
        <div class="col-md-10" id="resizableRight">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <p>Nombre de colonnes total (affiché) : <span id="nb_column">?</span> (<span
                                id="nb_column_show">?</span>)</p>
                </div>
            </div>
            <div id="canvasDiv" hidden></div>
...
<script>
    ...
    addFilterAuto(configJSON, configGraph['engine']);
        ...
        jq.get(url, function(dataRAW) {
             ...
             createSpeedFiltersTable2D(data,configGraph);
            tableCreate(data, configGraph);
            createSpeedFilterRangeTable2D(data, configGraph);
             getTableImg();
             document.getElementById('save_graph').disabled = false;
            createDownloadCSVButton(data, "", "<?=$config['table'] . " " . $update_time_table?>");
         }).fail(function(data) {
